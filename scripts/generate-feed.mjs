...
function generateRss(posts) {
  const items = posts
    ...
    .join('');
  return `<?xml version="1.0" encoding="UTF-8"?>\n<rss version="2.0">\n  <channel>\n    <title>Blog — Mohammad Amin Bozorgani</title>\n    <link>${DOMAIN}/blog</link>\n    <description>Articles on performance, SEO, and full-stack development.</description>\n    ${items}\n  </channel>\n</rss>\n`;
}
  ...
  return JSON.stringify(
    {
      ...
      title: 'Blog — Mohammad Amin Bozorgani',
