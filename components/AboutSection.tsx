  ...
  return (
    <section id="about" aria-labelledby="about-title" className="rounded-lg border p-6 space-y-4 dark:border-gray-800">
      ...
      <div className="space-y-4 text-gray-700 dark:text-gray-300">
        <p>
          من محمدامین بزرگانی، یک توسعه‌دهنده Full-Stack با بیش از ۱۰ سال تجربه در ساخت و توسعه وب‌اپلیکیشن‌های مدرن و مقیاس‌پذیر هستم. تخصص اصلی من در استفاده از تکنولوژی‌های مدرن JavaScript شامل React، Next.js و Node.js برای ساخت محصولات دیجیتالی با عملکرد بالا و تجربه کاربری عالی است.
        </p>
        <p>
