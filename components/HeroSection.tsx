...
export function HeroSection() {
  ...
  return (
    ...
    >
      {/* Decorative Background Elements - Reduced on mobile for better performance */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <motion.div
          className="absolute -top-20 -right-20 w-64 h-64 sm:w-96 sm:h-96 bg-gradient-to-br from-sky-200/30 to-blue-300/30 dark:from-sky-900/20 dark:to-blue-900/20 rounded-full blur-3xl hidden sm:block"
          animate={isMobile ? {} : {
            scale: [1, 1.2, 1],
            opacity: [0.3, 0.5, 0.3],
          }}
        ...
        />
        <motion.div
          className="absolute -bottom-20 -left-20 w-64 h-64 sm:w-96 sm:h-96 bg-gradient-to-br from-indigo-200/30 to-purple-300/30 dark:from-indigo-900/20 dark:to-purple-900/20 rounded-full blur-3xl hidden sm:block"
          animate={isMobile ? {} : {
            scale: [1.2, 1, 1.2],
            opacity: [0.3, 0.5, 0.3],
          }}
          ...
          <FadeInUp delay={0.7}>
            <div className="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4 pt-2">
              {isMobile ? (
                <Link 
                  href="#projects" 
                  className="group inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-brand to-brand-dark px-5 sm:px-6 py-2.5 sm:py-3 text-sm sm:text-base font-semibold text-white shadow-lg transition-all duration-300"
              ...
              {isMobile ? (
                <Link 
                  href="/resume" 
                  className="inline-flex items-center justify-center gap-2 rounded-xl border-2 border-gray-300 dark:border-gray-600 bg-white/80 dark:bg-gray-800/80 px-5 sm:px-6 py-2.5 sm:py-3 text-sm sm:text-base font-semibold text-gray-900 dark:text-gray-100 hover:bg-gray-50 dark:hover:bg-gray-700 transition-all duration-300 shadow-sm"
        ...
        <div className="flex items-center justify-center lg:justify-end order-1 lg:order-2 lg:col-span-2 py-4 sm:py-6 lg:py-0">
          {isMobile ? (
            ...
            <FadeInUp delay={0.6}>
              ...
              >
                <motion.div 
                  className="absolute -inset-2 sm:-inset-3 md:-inset-4 bg-gradient-to-r from-brand via-blue-500 to-indigo-500 rounded-full blur-xl opacity-75 group-hover:opacity-100 transition duration-300 hidden sm:block"
                  animate={{
                    rotate: [0, 360],
                  }}
                  transition={{
